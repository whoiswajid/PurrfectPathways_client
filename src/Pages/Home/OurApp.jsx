...
const OurApp = () => {
    return (
        <div className="">
            <div className="hero min-h-screen" style={{ backgroundImage: 'url(https://i.ibb.co/smd9Y45/3728913.jpg)' }}>
                <div className="hero-overlay bg-opacity-60"></div>
                <div className="hero-content text-center text-neutral-content">
                    <div className="max-w-md gap-9">
                        <section className="py-6 dark:bg-gray-800 dark:text-gray-50">
                            <div className="container mx-auto flex flex-col justify-around p-4 text-center md:p-10 lg:flex-row">
                                <div className="flex flex-col justify-center  lg:text-left">
                                    <p className="mb-1 text-sm font-medium tracki uppercase "></p>
                                    <h1 className="py-2 text-3xl font-bold font-serif leadi text-white title-font">Download Our PurrfectPathways App On</h1>
                                </div>
                                <div className="flex flex-col items-center justify-center flex-shrink-0 mt-6 space-y-4 sm:flex-row sm:space-y-0 sm:space-x-4 lg:ml-4 lg:mt-0 lg:justify-end">
                                    <a href="https://play.google.com/store/apps/details?id=your.package.name">
                                        <button className="inline-flex items-center px-6 py-3 rounded-lg  bg-rose-400 text-white" >
                                    ...
                                    <a href="https://apps.apple.com/us/app/your-app-name/id123456789">
                                        <button className="inline-flex items-center px-5 py-3 rounded-lg bg-rose-400 text-white" >
